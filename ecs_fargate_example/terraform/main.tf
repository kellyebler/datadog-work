...
resource "aws_cloudwatch_log_group" "app" {
  name              = "/ecs/sample-app-fargate"
  retention_in_days = 7

  tags = {
    Name = "ecs-sample-app-logs"
  }
}
